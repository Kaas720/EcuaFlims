...
export class AppComponent implements OnInit {
  ...
  cerrarDiv(){
    let DivOcultoLet1 = <HTMLVideoElement> document.getElementById("Div1");
    let DivOcultoLet2 = <HTMLVideoElement> document.getElementById("Div2");
    let DivOcultoLet3 = <HTMLVideoElement> document.getElementById("Div3");
    let DivOcultoLet4 = <HTMLVideoElement> document.getElementById("Div4");
