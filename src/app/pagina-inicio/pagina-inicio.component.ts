...
export class PaginaInicioComponent implements OnInit  {
  constructor(private ElByClassName: ElementRef,private lazyLoadService: LazyLoadService,private router: Router,private dialog:MatDialog) {}
  ...
  openShowModalDiaolog(){
    Swal.fire({
      title: 'Elige unas de las opciones',
      showDenyButton: true,
